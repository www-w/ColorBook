...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String TAG = "com.topv1.cyz";
    /**
...
//        return email.contains("@");
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return new CursorLoader(this, ContactsContract.CommonDataKinds.Phone.CONTENT_URI
                , new String[]{ContactsContract.Data.DISPLAY_NAME, ContactsContract.Data.SORT_KEY_PRIMARY, ContactsContract.Data.DATA1},
...
//                /*ContactsContract.Contacts.Data.IS_PRIMARY + " DESC"*/null);
    }
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        while (!cursor.isAfterLast()) {
            ...
            for (String column : cursor.getColumnNames()) {
                ...
                emails.add(cursor.getString(cursor.getColumnIndex(column)));
            }
